<?php
	...
	{
		echo '<tr> <td align="center">' . $row['ID'] . '</td> <td align="center">' . $row['Name'] . '</td> <td align="center">' . $row['Grade'] . '</td> <td align="center">' . $row['Phone'] . '</td> <td align="center">' . $row['ECName'] . '</td> <td align="center">' . $row['ECPhone'] . '</td> <td align="center">' . $row['TeamName'] . '</td> <td align="center"> <form name="edit" action="editplayer.php" method="POST"> <input name="ID" type="hidden" value="' . $row['ID'] . '"> <input name="Name" type="hidden" value="' . $row['Name'] . '"> <input type="submit" value="Edit"> </form> </td> </tr>';
	}
	while($row = $sql2->fetch(PDO::FETCH_ASSOC))
	{
		echo '<tr> <td align="center">' . $row['ID'] . '</td> <td align="center">' . $row['Name'] . '</td> <td align="center">' . $row['Grade'] . '</td> <td align="center">' . $row['Phone'] . '</td> <td align="center">' . $row['ECName'] . '</td> <td align="center">' . $row['ECPhone'] . '</td> <td align="center"> </td> <td align="center"> <form name="edit" action="editplayer.php" method="POST"> <input name="ID" type="hidden" value="' . $row['ID'] . '"> <input name="Name" type="hidden" value="' . $row['Name'] . '"> <input type="submit" value="Edit"> </form> </td> </tr>';
	}
	echo '</table>';
?>
